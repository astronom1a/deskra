...
// Logo SVLK di-inline (bukan <img src>) agar dijamin ikut ter-render saat cetak —
// asset eksternal di area display:none bisa gagal dimuat saat window.print()
function SvlkLogo({ style }) {
  return (
    <svg viewBox="0 0 310 122" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="SVLK Indonesia" style={style}>
      <path fill="#00a54b" d="M224.87,78.05c1.18,1.08,3.04.57,3.96,1.8,3.26,4.37,6.17,8.47,9.48,13.45-2.37.08-6.52,1.52-8.59-.28-3.11-2.71-10.08-15.85-10.26-11.03l-.41,11.35c-2.08.5-4.09.53-6.36-.01l.05-29.15c1.26-1.14,5.32-1.07,6,.56,1.43,3.44-.41,7.35.89,11.35l10.32-12.03c1.68-1.32,4.86-.37,7.27-.18-2.39,3.2-7.92,13.05-12.36,14.17Z"/>
      <path fill="#00a54b" d="M148.04,93.58c-5.21,1.3-11.48.13-14.95-3.92-1.12-1.31,1.81-4.09,2.82-4.81,3.39,2.92,11.96,5.51,12.5.61.41-3.77-7.92-3.42-12.28-6.67-2.85-2.13-3.45-5.86-2.54-9.16.84-3.05,3.54-5.81,7.45-6.28s9.14.05,11.92,3.34c.94,1.11-1.38,4.7-2.66,4.79-2.7-1.23-6.04-3.24-9.3-1.92-1.18.48-1.43,1.7-1.36,2.52.46,4.91,17.3,1.85,14.98,14.65-.52,2.87-2.6,5.87-6.58,6.86Z"/>
      <path fill="#00a54b" d="M178.07,64.63c.66-1.71,4.89-.87,6.57-.17l-11.08,28.95c-1.15,1.15-5.41.61-6.03-.96l-10.9-28.09c1.72-.8,5.04-1.06,6.69-.15l7.5,19.26,7.24-18.83Z"/>
      <path fill="#00a54b" d="M207.41,87.81c2.2.07,2.27,4.15,1.33,5.64-6.28.59-13.06.3-20.05.17l.06-29.16c0-1.49,5.38-1.35,5.78.1l.6,22.87,12.27.38Z"/>
      <g>
        <path fill="#00a54c" d="M165.34,27c.01-1.48-.33-1.76-1.04-.85-7.08,8.83-19.5,10.37-30.28,12.17-6.76,1.13-11.01,5.95-17.48,9.18,1.21-7.69,5.34-14.4,10.66-19.24,12.78-11.63,34.55-5.7,46.88-20.12,2.3,10.19,1.07,20.38-2.77,29.45-6.34,14.99-26.27,15.74-40.51,16.58-9.06.54-16.94,6.64-21.6,14.34l-15.42,25.46c-.71,1.17-2.47,2.5-3.74,1.13l-15.91-17.13c-2.31,9.24,2.35,18.07,9.26,22.13,8.27,4.86,18.12,3.05,24.17-3.06,6.65-6.71,7.88-16.81,2.96-25.1,1.24-3.38,3.64-6.22,6.79-8.74,8.3,10.19,9.11,24.12,2.61,35.21-6.32,10.78-18.63,16.95-31.54,14.78-11.65-1.96-20.71-10.65-23.98-20.83-3.83-11.91-.4-24.45,8.35-32.54l19.16,20.41c7.35-6.99,12.63-14.58,18.99-21.81,19.56-22.24,30.03-15.01,43.8-22.19,4.22-2.2,8.85-4.44,10.65-9.23Z"/>
        <path fill="#00a54b" d="M102.56,64.34c-7.12-2.99-13.95-2.73-20.16,1.41-2.7-2.22-4.52-4.58-7.19-7.8,9.4-7.69,22.89-8.52,33.32-2.28-1.47,3.47-3.26,5.74-5.97,8.67Z"/>
      </g>
      <g fill="#229e53">
        <path d="M137.26,102.14v11.47h-2.95v-11.47h2.95Z"/>
        <path d="M140.21,113.62v-11.47h3.49c3.32,5.11,4.26,6.48,4.99,7.87h.03c-.11-1.16-.1-3.36-.1-5.25v-2.62h2.7v11.47h-3.27c-.99-1.62-4.54-7.26-5.21-8.57h-.03c.1,1.41.1,3.04.1,5.08v3.49h-2.7Z"/>
        <path d="M154.29,102.14h5.25c3.89,0,6,2.52,6,5.53,0,3.67-2.72,5.94-6.06,5.94h-5.19v-11.47ZM157.24,111.34h1.87c2.13,0,3.31-1.17,3.31-3.58,0-2.05-1.02-3.32-3.28-3.35h-1.89v6.94Z"/>
        <path d="M179.61,107.84c0,3.17-2.11,6.02-6.33,6.02-3.92,0-6.13-2.66-6.13-6.01,0-3.15,2.35-5.96,6.27-5.96s6.19,2.82,6.19,5.94ZM170.26,107.82c0,2.13,1.04,3.75,3.19,3.75s3.05-1.92,3.05-3.7c0-1.98-.92-3.68-3.16-3.68s-3.08,1.77-3.08,3.63Z"/>
        <path d="M181.86,113.62v-11.47h3.49c3.32,5.11,4.26,6.48,4.99,7.87h.03c-.11-1.16-.1-3.36-.1-5.25v-2.62h2.7v11.47h-3.27c-.99-1.62-4.54-7.26-5.21-8.57h-.03c.1,1.41.1,3.04.1,5.08v3.49h-2.7Z"/>
        <path d="M205.21,108.85h-6.33v2.42h7.05l-.33,2.35h-9.67v-11.47h9.63v2.35h-6.68v2h6.33v2.35Z"/>
        <path d="M210.02,110.16c.32.94,1.08,1.55,2.93,1.55,1.72,0,2.18-.5,2.18-1.19,0-.74-.51-1.15-2.85-1.55-4.06-.7-4.77-2.02-4.77-3.55,0-2.33,2.25-3.5,4.99-3.5,3.97,0,5.06,2.04,5.19,3.39h-2.95c-.15-.54-.52-1.26-2.34-1.26-1.28,0-1.9.4-1.9,1.08,0,.62.47.92,2.56,1.3,4.39.79,5.08,2.11,5.08,3.79,0,2.01-1.58,3.63-5.48,3.63-3.64,0-5.26-1.62-5.61-3.68h2.95Z"/>
        <path d="M223.31,102.14v11.47h-2.95v-11.47h2.95Z"/>
        <path d="M228.74,111.14l-.93,2.48h-3.03l4.58-11.47h3.8l4.82,11.47h-3.19l-1-2.48h-5.04ZM232.97,108.78c-1.02-2.55-1.52-3.87-1.8-4.76h-.02c-.26.87-.84,2.59-1.67,4.76h3.48Z"/>
      </g>
    </svg>
  )
}
      ...
      {createPortal(
        <div id="qr-print-area" style={{ display: 'none' }}>
          <div style={{ flex: 1, width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
            <SvlkLogo style={{ width: '65%', maxWidth: '100mm', height: 'auto', aspectRatio: '310 / 122', marginBottom: '16mm', printColorAdjust: 'exact' }}/>
